    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
            <div class="container">
                ...
                <a href="#page-top" ><img class="logo_dk" src="assets/img/DK_logo.png" alt=""/></a>
            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-end">
                        <h1 class="text-uppercase text-white font-weight-bold">Hey, ik ben Dani.</h1>
        ...
        <section class="page-section bg-dark text-white">
            <div class="container text-center">
                <h2 class="mb-4">Download hier mijn CV voor meer informatie</h2>
                <a class="btn btn-light btn-xl" href="docs/CV.pdf" download="CV.pdf">Download</a>
            </div>
        </section>
        <!-- Contact-->
        ...
        <footer class="bg-light py-5">
            <div class="container"><div class="small text-center text-muted">Copyright © 2021 - Dani Kools</div></div>
        </footer>
        <!-- Bootstrap core JS-->
